...
foreach ($data as $record) {
    ...
    $params = [
        ...
        ':telephone_restaurant' => isset($record['telephone']) ? $record['telephone'] : null,
        ':site_restaurant'    => $record['website'],
        ':departement'        => $record['departement'],
        ':code_departement'   => $record['code_departement'],
        ':commune'            => $record['commune'],
        ':code_commune'       => $record['code_commune'],
        ':latitude'           => isset($record['geo_point_2d'][0]) ? $record['geo_point_2d'][0] : null,
        ':longitude'          => isset($record['geo_point_2d'][1]) ? $record['geo_point_2d'][1] : null,
        ':stars'              => $record['stars'],
